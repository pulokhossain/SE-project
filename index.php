...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">sohabakund@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+880 1627113383</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"><span>BEST HOTEL BD</span><p class="logo_w3l_agile_caption">ALL YOU WANT</p></a></h1>
				</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><marquee class="text-animation" width="100%" direction="left" height="100px">
HOT SUMMER OFFER 2023 !!!         OFF 30% FOR ROOMS !!!  OFF 20% IN CAR RENT !!!   OFF 20% IN FOOD ITEMS !!!  SPECIAL BLOG SITE !!!
</marquee></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">MASTER BEDROOMS WITH BELCONI</h4>
							<span class="cbp-ig-category">BEST HOTEL BD</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">ABOUT OUR BEST HOTEL BD</h3> 
...
<!-- team -->
<div>
	<h1 class="team-head">Meet Our Team Members</h1>
</div>
<div class="container">
	<div class="row">
		<div class="col-md-3 col-xs-12">
			<div class="team-member default">
				<div class="person-inner">
					<div class="thumb-avatar">
						<a href="#"><img alt="" src="images/pulok.jpg"></a>
						<div class="list-social">
							<a href="https://www.facebook.com/a.stranger.5437"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
					<div class="content-person">
						<h3 class="name"><a href="#">Sohab Akund Polak</a></h3>
						<p class="positions">Member01</p>
						<p class="positions">ID : 2035502003</p>
						<p class="positions">Department of CSE</p>
						<p class="positions">City University</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 col-xs-12">
			<div class="team-member default">
				<div class="person-inner">
					<div class="thumb-avatar">
						<a href="#"><img alt="" src="images/rocky.jpg"></a>
						<div class="list-social">
							<a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
					<div class="content-person">
						<h3 class="name"><a href="#">Rocky Hossain</a></h3>
						<p class="positions">Member02</p>
						<p class="positions">ID : 1935202055</p>
						<p class="positions">Department of CSE</p>
						<p class="positions">City University</p>
					</div>
				</div>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">DHAKA</h3>
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">KHULNA</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">BARISHAL</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">CHITTAGONG</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">MYMENSINGH</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
	 ...
	 <!--// rooms & rates -->
      ...
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">SYLHET</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
					...
					<ul class="slides">
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/visitor.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/visitor2.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/visitor.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/visitor3.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>IT WAS A GREAT EXPERIENCE WITH "BEST HOTEL BD". 
									THIS IS AN ADVANCED TOUR MANAGEMENT SITE EVER MET.
									ALL THE BEST WISHES FOR YOU GUYS. </p>
								<h5>MR SELIM AND HIS FAMILY</h5>
								<p>BOGRA</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+880 1627113383</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="sohabakund@gmail.com">sohabakund@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> City University, Ashulia, Dhaka,Bangladesh</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 BEST TRAVEL BD . All Rights Reserved | Design by <a href="index.php">Sohab Akund Polak,Rocky Hossain</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
